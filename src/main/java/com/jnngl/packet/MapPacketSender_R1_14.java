...
public class MapPacketSender_R1_14 extends PacketSender implements MapPacketSender {
    ...
    @Override
    public Object createPacket(int mapId, ThreadLocal<ColorMatcher> colorMatcher, BufferedImage data) throws ReflectiveOperationException {
        return packet.newInstance(mapId, (byte)0, false, false,
                new ArrayList<>(), colorMatcher.get().matchImage(data), 0, 0, 128, 128);
    }
